...
import { ProtectedRoute, ProtectedLoginRoute } from "./userAuthentication/ProtectRoute/ProtectedRoutes";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/login", element: <ProtectedLoginRoute><LoginFormMain /></ProtectedLoginRoute> },
