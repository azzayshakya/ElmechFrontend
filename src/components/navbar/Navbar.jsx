      ...
      <div className="Header">
        ...
        <div className="navbarMid">
          <ul className={`navbarMenu ${isOpen ? 'open' : ''}`}>
            ...
            <li className="navbarNames">
              <Link className="LinkTAG" to={'/aboutUs'} onClick={onAboutUsClick}>
                About Us
              </Link>
            </li>
            <li className="navbarNames">
              <Link className="LinkTAG" to={'/services'} onClick={onServicesClick}>
                Services
              </Link>
            </li>
            {/* <li className="navbarNames">
            ...
            <li className="navbarNames ">
              <Link className="LinkTAG" to={'/getInTouch'} onClick={onContactClick}>
                Contact Us
              </Link>
            </li>
            {user?.userRole === 'admin' && (
              <>
                <li className="navbarNames">
                  <Link className="LinkTAG" to="/elmech-user-comments">
                    Comments
                  </Link>
                </li>
                <li className="navbarNames">
                  <Link className="LinkTAG" to="/elmech-user-Queries">
                    Queries
                  </Link>
                </li>
              </>
    ...
    <li>
      <Link className="LinkTAG" to="/queries">Queries</Link>
            ...
            {user ? (
              ...
              <>
                <li className="navbarNames  button-33-navbar  ">
                  <Link className="LinkTAG" to="/create-account">
                    Sign Up
                  </Link>
                </li>
                <li className="navbarNames  button-33-navbar ">
        ...
        <div className="toggle">
          <button onClick={toggleButton}>{isOpen ? <ImCross /> : <FaBars />}</button>
        </div>
      </div>
